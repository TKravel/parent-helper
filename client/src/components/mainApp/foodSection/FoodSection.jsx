...
function FoodInput({ foodData, onFoodChange, isEditing, tableRefresh, cachedData }){ 
    ...
    // // console.log(cachedData[isEditing.cacheDbDataIndex].food)
    // console.log(cachedData.length)
    // if(cachedData.length !== 0 ){
    //   if(foodData.length != cachedData[isEditing.cacheDbDataIndex].food.length){
    //     console.log("test")
    //     changes = true;
    //   } else {
    //     console.log('test2')
              ...
              {foodData.length === 0 ? 
                ...
                return (
                    <li key={index} index={index}>
                      {food}
                      <button className="deleteListItem" index={index} onClick={handleDelete}>
