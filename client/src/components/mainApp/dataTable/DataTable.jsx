...
import { convertTo12HR, calcNapTime, displayDate } from '../../../dateTimeHelpers';
    ...
    {dataRecords.length === 0 ?
        ...
        <table>
            <tbody>
                ...
                <CreateRows edit={edit} data={dataRecords} toggleModal={handleModal}/>
            </tbody>
        </table>
    }
    <Modal isOpen={isModelOpen} toggleModal={handleModal} data={modalState}/>
    </>
