    ...
    return keys.map((key, index)=>{
        if(key === "Edit"){
            ...
            if(item[key] === 'No data'){
                ...
                return (
                    <td key={item[key] + index} id={key} data-items={item[key][1]} data-date={item['date']} data-amount={item[key][0]}>
                        {item[key][0] + 'Items'}
                        <button className="editButton" onClick={toggleModal} style={{display: 'inline'}}>
